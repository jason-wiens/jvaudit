    ...
    <>
          ...
          <div className="flex-1 flex py-16 flex-col items-start">
            ...
            <div className="w-full mb-28">
              ...
              <div className="text-xl">
                ...
                jvAudit.io organizes your audit work and communication securly
                so all stakeholders remain engaged for faster audit resolutions.
              </div>
            </div>
            <Button asChild>
              <Link href={AppRoutes.LoginPage()}>Get Started</Link>
      ...
      <footer className="w-full border-t border-zinc-100 ">
        <div className="w-full max-w-7xl py-4 px-4 sm:px-6 lg:px-8 mx-auto">
          <p>
            <small>&copy; Root & Stem Design 2024</small>
          </p>
        </div>
      </footer>
    </>
