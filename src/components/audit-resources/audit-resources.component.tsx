...
import { addResource } from "../../state/audit/actions/add-resource";
import { deleteResource } from "../../state/audit/actions/delete-resource";
...
import type { Audit, Employee, Resource } from "@/state/audit/types";
