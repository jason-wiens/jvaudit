...
import { deleteStakeholder } from "../../state/audit/actions/delete-stakeholder";
import { addStakeholder } from "../../state/audit/actions/add-stakeholder";
...
import { Audit } from "@/state/audit/types";
