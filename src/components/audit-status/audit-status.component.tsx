...
const AuditStatusComponent: React.FC<AuditStatusProps> = ({
  ...
  const statusItems: {
    ...
    {
      status: AuditStatus.PREPERATION,
      name: "Audit Preperation",
      completed: progression[AuditStatus.PREPERATION] < currentStatus,
      active: currentStatus === progression[AuditStatus.PREPERATION],
    },
    {
